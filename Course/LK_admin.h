...
public: System::Windows::Forms::Button^ EditDataUsers_panel_EditUser_delete_user;
public: System::Windows::Forms::Panel^ PanelViewListAllBooksAndAllUsers;
...
private: System::Windows::Forms::Button^ LoginMainPanel_btn;
	...
	#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->EditDataUsers_panel_EditUser_delete_user = (gcnew System::Windows::Forms::Button());
			...
			this->MainPanel->Size = System::Drawing::Size(980, 593);
			...
			this->MainLeftPanel->Controls->Add(this->AddBookToUser);
			...
			this->label1->Location = System::Drawing::Point(10, -1);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(187, 58);
			...
			this->PanelAddBookToUser_Book_Grid->ColumnHeadersDefaultCellStyle = dataGridViewCellStyle1;
			this->PanelAddBookToUser_Book_Grid->ColumnHeadersHeight = 29;
			...
			this->PanelAddBookToUser_User_Grid->ColumnHeadersDefaultCellStyle = dataGridViewCellStyle2;
			this->PanelAddBookToUser_User_Grid->ColumnHeadersHeight = 29;
			...
			// 
			this->PanelViewListAllBooksAndAllUsers->AutoSize = true;
			this->PanelViewListAllBooksAndAllUsers->AutoSizeMode = System::Windows::Forms::AutoSizeMode::GrowAndShrink;
			this->PanelViewListAllBooksAndAllUsers->BackColor = System::Drawing::Color::BurlyWood;
			this->PanelViewListAllBooksAndAllUsers->BorderStyle = System::Windows::Forms::BorderStyle::FixedSingle;
			this->PanelViewListAllBooksAndAllUsers->Controls->Add(this->label38);
			this->PanelViewListAllBooksAndAllUsers->Controls->Add(this->ViewListAllBooksAndAllUsers_Grid);
			this->PanelViewListAllBooksAndAllUsers->Location = System::Drawing::Point(0, 35);
			this->PanelViewListAllBooksAndAllUsers->MaximumSize = System::Drawing::Size(780, 565);
			this->PanelViewListAllBooksAndAllUsers->Name = L"PanelViewListAllBooksAndAllUsers";
			this->PanelViewListAllBooksAndAllUsers->Size = System::Drawing::Size(2, 562);
			this->PanelViewListAllBooksAndAllUsers->TabIndex = 3;
			// 
			// label38
			// 
			this->label38->Dock = System::Windows::Forms::DockStyle::Top;
			this->label38->Font = (gcnew System::Drawing::Font(L"Impact", 15.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label38->Location = System::Drawing::Point(0, 0);
			this->label38->Name = L"label38";
			this->label38->Size = System::Drawing::Size(0, 30);
			this->label38->TabIndex = 1;
			this->label38->Text = L"Список книг и кому они выданы";
			this->label38->TextAlign = System::Drawing::ContentAlignment::TopCenter;
			// 
			// ViewListAllBooksAndAllUsers_Grid
			// 
			this->ViewListAllBooksAndAllUsers_Grid->AllowUserToAddRows = false;
			this->ViewListAllBooksAndAllUsers_Grid->AllowUserToDeleteRows = false;
			this->ViewListAllBooksAndAllUsers_Grid->AllowUserToResizeColumns = false;
			this->ViewListAllBooksAndAllUsers_Grid->AllowUserToResizeRows = false;
			this->ViewListAllBooksAndAllUsers_Grid->AutoSizeColumnsMode = System::Windows::Forms::DataGridViewAutoSizeColumnsMode::AllCells;
			this->ViewListAllBooksAndAllUsers_Grid->BackgroundColor = System::Drawing::Color::NavajoWhite;
			...
			this->ViewListAllBooksAndAllUsers_Grid->ColumnHeadersDefaultCellStyle = dataGridViewCellStyle3;
			this->ViewListAllBooksAndAllUsers_Grid->ColumnHeadersHeight = 29;
			...
			this->ViewListAllBooksAndAllUsers_Grid->Margin = System::Windows::Forms::Padding(20);
			this->ViewListAllBooksAndAllUsers_Grid->MaximumSize = System::Drawing::Size(781, 530);
			this->ViewListAllBooksAndAllUsers_Grid->MinimumSize = System::Drawing::Size(781, 530);
			this->ViewListAllBooksAndAllUsers_Grid->Name = L"ViewListAllBooksAndAllUsers_Grid";
			this->ViewListAllBooksAndAllUsers_Grid->RowHeadersWidthSizeMode = System::Windows::Forms::DataGridViewRowHeadersWidthSizeMode::AutoSizeToAllHeaders;
			this->ViewListAllBooksAndAllUsers_Grid->Size = System::Drawing::Size(781, 530);
			this->ViewListAllBooksAndAllUsers_Grid->StandardTab = true;
			this->ViewListAllBooksAndAllUsers_Grid->TabIndex = 0;
			// 
			// PanelDeleteBook
			// 
			...
			this->FullListBookInDB_DataGridView->ColumnHeadersDefaultCellStyle = dataGridViewCellStyle4;
			this->FullListBookInDB_DataGridView->ColumnHeadersHeight = 29;
			...
			this->RegUser_rBtn_admin->Size = System::Drawing::Size(216, 35);
			...
			this->RegUser_rBtn_reader->Size = System::Drawing::Size(139, 35);
			...
			this->RegUser_birthday->Size = System::Drawing::Size(126, 34);
			...
			this->RegUser_pass->Size = System::Drawing::Size(510, 34);
			...
			this->RegUser_login->Size = System::Drawing::Size(510, 34);
			...
			this->RegUser_patronymic->Size = System::Drawing::Size(510, 34);
			...
			this->RegUser_SurName->Size = System::Drawing::Size(510, 34);
			...
			this->RegUser_Name->Size = System::Drawing::Size(510, 34);
			...
			this->label15->Size = System::Drawing::Size(510, 42);
			...
			this->label14->Size = System::Drawing::Size(425, 42);
			...
			this->label13->Size = System::Drawing::Size(272, 42);
			...
			this->label12->Size = System::Drawing::Size(256, 42);
			...
			this->label11->Size = System::Drawing::Size(302, 42);
			...
			this->label10->Size = System::Drawing::Size(314, 42);
			...
			this->label9->Size = System::Drawing::Size(225, 42);
			...
			this->Search_Find_from_reader_Grid_Select->ColumnHeadersDefaultCellStyle = dataGridViewCellStyle5;
			this->Search_Find_from_reader_Grid_Select->ColumnHeadersHeight = 29;
			...
			this->Search_Find_from_reader_Grid_name->ColumnHeadersDefaultCellStyle = dataGridViewCellStyle6;
			this->Search_Find_from_reader_Grid_name->ColumnHeadersHeight = 29;
			...
			this->label36->Size = System::Drawing::Size(572, 31);
			...
			this->Search_Find_from_authors_Count_taken->Size = System::Drawing::Size(29, 31);
			...
			this->Search_Find_from_authors_Count_All->Size = System::Drawing::Size(29, 31);
			...
			this->label35->Size = System::Drawing::Size(446, 31);
			...
			this->Search_Find_from_authors_Grid_Search->ColumnHeadersDefaultCellStyle = dataGridViewCellStyle7;
			this->Search_Find_from_authors_Grid_Search->ColumnHeadersHeight = 29;
			...
			this->Search_Find_from_authors_Grid_Authors->ColumnHeadersDefaultCellStyle = dataGridViewCellStyle8;
			this->Search_Find_from_authors_Grid_Authors->ColumnHeadersHeight = 29;
			...
			this->label33->Size = System::Drawing::Size(577, 46);
			...
			this->PanelEditInfoBook->Location = System::Drawing::Point(783, 546);
			...
			this->PanelEditInfoBook_edit->Location = System::Drawing::Point(364, 304);
			...
			this->lEditInfoBook_edit_ID->Size = System::Drawing::Size(0, 17);
			...
			this->label32->Size = System::Drawing::Size(71, 17);
			...
			this->EditInfoBook_release_data->Size = System::Drawing::Size(126, 34);
			...
			this->EditInfoBook_creation_data->Size = System::Drawing::Size(126, 34);
			...
			this->label26->Size = System::Drawing::Size(322, 31);
			...
			this->label27->Size = System::Drawing::Size(292, 31);
			...
			this->label28->Size = System::Drawing::Size(307, 31);
			...
			this->label29->Size = System::Drawing::Size(283, 31);
			...
			this->label30->Size = System::Drawing::Size(232, 31);
			...
			this->label31->Size = System::Drawing::Size(244, 31);
			...
			this->EditInfoBook_count_page->Size = System::Drawing::Size(126, 34);
			...
			this->EditInfoBook_ContextTextBox->Size = System::Drawing::Size(759, 34);
			...
			this->EditInfoBook_AutorsTextBox->Size = System::Drawing::Size(759, 34);
			...
			this->EditInfoBook_NameTextBox->Size = System::Drawing::Size(759, 34);
			...
			this->EditInfoBook_dataGridView->ColumnHeadersDefaultCellStyle = dataGridViewCellStyle9;
			this->EditInfoBook_dataGridView->ColumnHeadersHeight = 29;
			...
			this->PanelEditDataUsers->Location = System::Drawing::Point(0, 35);
			...
			this->EditDataUsers_panel_select_dataGridView->ColumnHeadersDefaultCellStyle = dataGridViewCellStyle10;
			this->EditDataUsers_panel_select_dataGridView->ColumnHeadersHeight = 29;
			...
			// 
			this->EditDataUsers_panel_EditUser->Controls->Add(this->EditDataUsers_panel_EditUser_delete_user);
			...
			// 
			// EditDataUsers_panel_EditUser_delete_user
			// 
			this->EditDataUsers_panel_EditUser_delete_user->BackColor = System::Drawing::Color::NavajoWhite;
			this->EditDataUsers_panel_EditUser_delete_user->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Regular,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(204)));
			this->EditDataUsers_panel_EditUser_delete_user->Location = System::Drawing::Point(7, 383);
			this->EditDataUsers_panel_EditUser_delete_user->Name = L"EditDataUsers_panel_EditUser_delete_user";
			this->EditDataUsers_panel_EditUser_delete_user->Size = System::Drawing::Size(156, 72);
			this->EditDataUsers_panel_EditUser_delete_user->TabIndex = 28;
			this->EditDataUsers_panel_EditUser_delete_user->Text = L"Удалтить аккаунт";
			this->EditDataUsers_panel_EditUser_delete_user->UseVisualStyleBackColor = false;
			this->EditDataUsers_panel_EditUser_delete_user->Click += gcnew System::EventHandler(this, &LK_admin::EditDataUsers_panel_EditUser_delete_user_Click);
			// 
			...
			this->EditDataUsers_panel_EditUser_ID->Size = System::Drawing::Size(0, 17);
			...
			this->label24->Size = System::Drawing::Size(127, 17);
			...
			this->EditDataUsers_panel_EditUser_admin->Size = System::Drawing::Size(216, 35);
			...
			this->EditDataUsers_panel_EditUser_reader->Size = System::Drawing::Size(139, 35);
			...
			this->EditDataUsers_panel_EditUser_birthday->Size = System::Drawing::Size(126, 34);
			...
			this->EditDataUsers_panel_EditUser_pass->Size = System::Drawing::Size(510, 34);
			...
			this->EditDataUsers_panel_EditUser_login->Size = System::Drawing::Size(510, 34);
			...
			this->EditDataUsers_panel_EditUser_patronymic->Size = System::Drawing::Size(510, 34);
			...
			this->EditDataUsers_panel_EditUser_surname->Size = System::Drawing::Size(510, 34);
			...
			this->EditDataUsers_panel_EditUser_name->Size = System::Drawing::Size(510, 34);
			...
			this->label17->Size = System::Drawing::Size(314, 42);
			...
			this->label18->Size = System::Drawing::Size(267, 42);
			...
			this->label19->Size = System::Drawing::Size(141, 42);
			...
			this->label20->Size = System::Drawing::Size(124, 42);
			...
			this->label21->Size = System::Drawing::Size(173, 42);
			...
			this->label22->Size = System::Drawing::Size(170, 42);
			...
			this->label23->Size = System::Drawing::Size(94, 42);
			...
			this->release_data->Size = System::Drawing::Size(126, 34);
			...
			this->creation_data->Size = System::Drawing::Size(126, 34);
			...
			this->label7->Size = System::Drawing::Size(438, 31);
			...
			this->label6->Size = System::Drawing::Size(406, 31);
			...
			this->label5->Size = System::Drawing::Size(421, 31);
			...
			this->label4->Size = System::Drawing::Size(397, 31);
			...
			this->label3->Size = System::Drawing::Size(325, 31);
			...
			this->label2->Size = System::Drawing::Size(359, 31);
			...
			this->count_page->Size = System::Drawing::Size(126, 34);
			...
			this->ContextTextBox->Size = System::Drawing::Size(759, 34);
			...
			this->AutorsTextBox->Size = System::Drawing::Size(759, 34);
			...
			this->NameTextBox->Size = System::Drawing::Size(759, 34);
			...
			this->LabelUpMainRightPanel->Size = System::Drawing::Size(0, 25);
			...
			// UserMainPanel_btn
			// 
			this->UserMainPanel_btn->Location = System::Drawing::Point(851, 7);
			this->UserMainPanel_btn->Name = L"UserMainPanel_btn";
			this->UserMainPanel_btn->Size = System::Drawing::Size(112, 53);
			...
			this->UserMainPanel_Grid->RowHeadersWidth = 51;
			...
			this->label41->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 20.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label41->Location = System::Drawing::Point(7, 27);
			this->label41->Name = L"label41";
			this->label41->Size = System::Drawing::Size(257, 39);
			...
			this->DataLabel->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 20.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->DataLabel->Location = System::Drawing::Point(257, 26);
			this->DataLabel->Name = L"DataLabel";
			this->DataLabel->Size = System::Drawing::Size(137, 39);
			...
			this->loginField->Size = System::Drawing::Size(256, 68);
			...
			this->passField->Size = System::Drawing::Size(256, 68);
			...
			this->ClientSize = System::Drawing::Size(980, 593);
